...
This is a basic search-based implementation of the [Battlesnake API](https://docs.battlesnake.com/references/api). This snake competed in RBC's 2021 winter battlesnake challenge.
